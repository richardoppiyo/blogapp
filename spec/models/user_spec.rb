...
RSpec.describe User, type: :model do
  subject { User.new(name: 'Richard Opiyo', photo: 'https://imgv3.fotor.com/images/homepage-feature-card/Fotor-AI-photo-enhancement-tool.jpg', bio: 'I am asoftware dev', posts_counter: 5) }
